...
def show_dialog_non_informative_text_timed(parent, window_title, message, informative_text, buttons=QtWidgets.QMessageBox.Ok | QtWidgets.QMessageBox.Cancel, icon=QtWidgets.QMessageBox.Critical):
    time_to_close = 900           #900
