...
class Ui_QueryUserSimple(object):
    def setupUi(self, QueryUserSimple):
        ...
        QueryUserSimple.setTabOrder(self.email_field, self.member_since_field)
        QueryUserSimple.setTabOrder(self.member_since_field, self.export_query)
...
"any parameter"))
        ...
        self.label_5.setText(_translate("QueryUserSimple", "Member Since"))
        self.member_since_field.setDisplayFormat(_translate("QueryUserSimple", "MM/dd/yyyy"))
