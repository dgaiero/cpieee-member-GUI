...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.widget.setGeometry(QtCore.QRect(10, 110, 411, 81))
        ...
        self.phone_field = QtWidgets.QLineEdit(self.widget)
        font = QtGui.QFont()
        font.setFamily("Fira Code Medium")
        font.setPointSize(10)
        ...
        self.options_button = QtWidgets.QPushButton(self.widget)
        font = QtGui.QFont()
        font.setFamily("Fira Code Medium")
        font.setPointSize(10)
        ...
        Dialog.setTabOrder(self.phone_field, self.password_field)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label_2.setText(_translate("Dialog", "<html><head/><body><p><img src=\":/loginHeader/header_background_logo.gif\"/></p></body></html>"))
